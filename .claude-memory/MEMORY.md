...
- [必須LC 100%要件と修正の全体像](mandatory-lc-100pct-requirement.md) — 作動範囲内100%達成(pass6)・PR#56レビュー待ちのみ／2指標分離（衝突は別掲・ゼロ化はIssue#57）／修正4系統＋壁ペアスワップ／forensic・verify_sweepツールは tools/ 配下／運用の罠
